/* The main Java application provided by Duo. 
 * Duo provides four different Java applications that all must be used, DuoWeb, DuoWebException, Base64, and Util
 * This Java file uses DuoWebException to catch any specific exceptions that are potentially thrown
 * It uses Util and Base64 as part of its encryption and key generation process 
 */
